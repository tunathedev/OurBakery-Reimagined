...
export const STREAMS = [
  {
    ...
    blurb: 'Set the standards and cheer the team on.',
  },
  {
    ...
    blurb: 'Your steps, what to pull, how busy it’ll be, and what to make.',
  },
  {
    ...
    orderRole: 'receive',
    blurb: 'Freezer pulls, what to make, take in cake orders, and count the floor.',
  },
  {
  ...
  },
  {
    ...
    orderRole: 'place',
    blurb: 'Opener, midday, closer. Steps, pulls, and start new cake orders.',
  },
  {
  ...
  },
  {
    ...
    capabilities: [],
    catalogScope: null, freezerMode: false, productionMode: null, processId: null,
    blurb: 'Ready-To-Sell — the app you already use. It opens on its own.',
  },
];
...
export const CAP_LABEL = {
  ...
  pull: 'Pull List',
  forecast: 'How Busy',
  production: 'Make List',
  order: 'Cake Orders',
  inventory: 'Floor Count',
  standards: 'Standards',
  people: 'Team',
  ledger: 'Activity',
};
